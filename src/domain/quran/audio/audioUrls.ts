...
import { SURAH_AYAH_COUNTS } from "./reciters";
...
const ISLAMIC_APP_AUDIO_BASE = "https://cdn.islamic.app/quran/audio";

/** Word-by-word audio from Quran Foundation CDN. */
const WORD_AUDIO_BASE = "https://verses.quran.foundation/";

function toGlobalAyahNumber(surah: number, ayah: number): number {
