...
type ReciterAudioSource = "everyayah" | "islamicapp";
...
const RECITER_CATEGORY_LABELS: Record<ReciterCategory, string> = {
...
const FOLDER_TO_NAME_EN: Record<string, string> = {
  ...
  "Ahmed_ibn_Ali_al-Ajamy_64kbps_QuranExplorer.Com":
    "Ahmed ibn Ali al-Ajamy QuranExplorer.Com",
  "Ahmed_ibn_Ali_al-Ajamy_128kbps_ketaballah.net":
    "Ahmed ibn Ali al-Ajamy KetabAllah.Net",
